...
async function getAppmapStats(config) {
    var _a;
    ...
    let numAppMaps = 0;
    const appmapDir = (0, path_1.join)(config.directory, (_a = config.appmap_dir) !== null && _a !== void 0 ? _a : 'tmp/appmap');
...
async function collectStats(cachedConfigs) {
    const configs = cachedConfigs !== null && cachedConfigs !== void 0 ? cachedConfigs : (await (0, configuration_1.default)().configs());
