...
exports.formatHttpServerRequest = exports.formatValue = exports.prefixLines = exports.exists = exports.findFiles = exports.processNamedFiles = exports.processFiles = exports.ProcessFileOptions = exports.writeFileAtomic = exports.isFile = exports.mtime = exports.isCodedError = exports.splitCamelized = exports.isCamelized = exports.baseName = exports.verbose = exports.endTime = void 0;
...
function isCamelized(str) {
    if (str.length < 3)
        return false;
    const testStr = str.slice(1);
    return /[a-z][A-Z]/.test(testStr);
}
exports.isCamelized = isCamelized;
function splitCamelized(str) {
    if (!isCamelized(str))
        return str;
