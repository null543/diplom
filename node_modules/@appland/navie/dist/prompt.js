...
function buildPromptDescriptor(promptType) {
    ...
    if (prompt.multiple) {
        content.push(`Multiple ${PROMPT_NAMES[promptType].plural} of this type will be provided. Each one will be prefixed with "[${prompt.prefix}]"`);
    }
    else {
        content.push(`The ${PROMPT_NAMES[promptType].singular} will be prefixed with "[${prompt.prefix}]"`);
    }
    return content.join('\n\n');
}
