...
export default class ExplainAgent implements Agent {
    ...
    constructor(history: InteractionHistory, vectorTermsService: VectorTermsService, lookupContextService: LookupContextService, applyContextService: ApplyContextService);
